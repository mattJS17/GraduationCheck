<?php
  ...
  $query_mysql="SELECT * FROM graduation";
      ...
      <div class="mdl-grid">
        ...
        <table class="mdl-data-table mdl-js-data-table mdl-data-table--unselectable mdl-shadow--2dp mdl-cell mdl-cell--10-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-cell--1-offset-desktop">
                ...
                <tr>
                    ...
                    <th style="text-align: center;">값<br>설정</style>
                  </tr>
                </thead>
                <tbody>
                  <!--?php
            ...
            ?-->
                    ...
                    <?php
                      for($i = 0; $i < $totalGraduation; $i++){
                        ...
                        echo "onclick = \"setValue(" . $major . "); return false;\"/> 설정하기 <td>";
                        echo "</td></tr>";
                      }
    ...
    function setValue(no) {
      ...
      xmlhttp.onreadystatechange = function() {
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
          ...
          document.getElementById("button_" + no).style.display = "";
        }
        xmlhttp.open("POST", "sql_insert.php", true);
        xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        xmlhttp.send("coreEs="+ecoreEs+"&coreSe="+coreSe+"&majorBasic="+majorBasic+"&majorEs="+majorEs+"&majorSe="+majorSe+"&gradTotal="+gradTotal+"&gradKey="+no);
      }
    }
  </script>
</body>
