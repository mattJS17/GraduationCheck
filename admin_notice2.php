          ...
          <table class="mdl-data-table mdl-js-data-table mdl-data-table--unselectable mdl-shadow--2dp mdl-cell mdl-cell--10-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-cell--1-offset-desktop">
            ...
            <tbody>
              ...
              while($result_each = mysqli_fetch_array($result)){
                echo "<tr><td style='text-align: center;'>" . $result_each["noticeKey"] . "</td><td style='text-align: center;'><a data-toggle=\"modal\" href=\"#modal\" onclick=\"ajax_notice_content(" . $result_each["noticeKey"] . ");\">" . $result_each["title"] . "</a></td><td style='text-align: center;'>관리자</td><td style='text-align: center;'>" . $result_each["date"] . "</td></tr>";
