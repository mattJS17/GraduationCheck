...
mysqli_select_db($connect, "macDB");
  $mytotal = 0;
  $query_mysql3="SELECT *  FROM subject JOIN complete ON subject.subKey = complete.subjectKey  WHERE complete.studentId = '$member[1]' and subject.adYear = '$member[8]' and subject.designCredit >= 1 ORDER BY year asc, semester asc, field asc ";
  $result3 = mysqli_query($connect, $query_mysql3);
  for($i=0; $i < mysqli_num_rows($result3); $i++ ){
    $result_each3 = mysqli_fetch_assoc($result3);
     $mytotal += $result_each3["designCredit"];
  }
       ...
       <div class="mdl-grid">
           ...
           <div class="mdl-list mdl-shadow--2dp mdl-color--white">
             <div class="mdl-list__item">
               <span class="mdl-list__item-primary-content">
                 ...
                 <span><strong>설계 총점 : <?php echo $mytotal ?>/12</strong><!--?php echo $member[3] . " (" . $member[2] . ")"; ?--></span>
               </span>
         ...
         <table class="mdl-data-table mdl-js-data-table mdl-data-table--unselectable mdl-shadow--2dp mdl-cell mdl-cell--10-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-cell--1-offset-desktop" style="text-align: center;">
                 ...
                 <tr>
                     ...
                     <th style="text-align: center;">설계 학점</th>
                   </tr>
                 </thead>
                 <tbody>
                     <?php
                     for($i=0; $i < mysqli_num_rows($result3); $i++ ){
                       ...
                       echo " <tr> <td style=\"text-align: center;\"> ";
                        ...
                        echo "<td style=\"text-align: center;\">".$result_each3["designCredit"]."</td>";
                          echo "</tr>";
                     }?>
                 </tbody>
         </table>
