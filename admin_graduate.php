...
WHERE member.studentId = bookAuth.studentId and member.studentId = englishAuth.studentId and bookAuth.studentId = englishAuth.studentId";
 ...
 <body>
   <div class="layout-auth mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
     ...
     <main class="mdl-layout__content">
           ...
           <div class="mdl-list mdl-shadow--2dp mdl-color--white">
             <div class="mdl-list__item">
               <span class="mdl-list__item-primary-content">
                 ...
                 <span><strong>졸업 가능 학생 조회</strong><!--?php echo $member[3] . " (" . $member[2] . ")"; ?--></span>
               </span>
       ...
       for(; $i<= $total; $i++){
         echo "<a href=\"admin_graduate.php?page=".$i."\">".$i." </a>";
       }
       echo "</div>";
        ?>
        </td>
